...
describe SitePrism::Page do
  ...
  describe "with a full string URL matcher" do
    ...
    it "matches with all elements matching plus extra query params" do
      swap_current_url("https://joe:bump@bla.org:443/foo?bar=baz&bar=boof&bar=bing&boom=bozzle#myfragment")
      expect(page.displayed?).to eq(true)
    end
