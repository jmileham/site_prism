Then /^I can see elements in the section$/ do
  ...
  expect(@test_site.home.people.title.text).to eq "People"
  expect(@test_site.home.people).to have_title :text => "People"
end
...
Then /^that section is there too$/ do
  ...
  expect(@test_site.page_with_people.people_list.title.text).to eq "People"
  expect(@test_site.page_with_people.people_list).to have_title :text => "People"
end
